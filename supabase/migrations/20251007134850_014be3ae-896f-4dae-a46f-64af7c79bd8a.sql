-- Create a secure view for profiles that automatically masks contact information
-- This provides an additional layer of protection for developers
...
COMMENT ON VIEW public.profiles_safe IS 'Secure view of profiles table that automatically masks contact information based on viewer permissions. Use this view instead of direct queries to profiles table for enhanced security.';