-- Fix change_user_role to create personal care space for ALL roles
...
BEGIN
  ...
  -- CASE 1: No existing membership - ALWAYS create personal care space
  IF _memberships_count = 0 THEN
    ...
    -- Create personal family for ANY role
