...
-- Update profiles table to include care_recipient_name for disabled persons
ALTER TABLE public.profiles 
ADD COLUMN care_recipient_name text NULL;
...
ALTER TABLE public.profiles ALTER COLUMN default_role TYPE app_role USING default_role::text::app_role;
ALTER TABLE public.profiles ALTER COLUMN default_role SET DEFAULT 'carer';